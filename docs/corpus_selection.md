...
All six documents are document types the author worked with directly across 12 years in HVAC, subsea, and manufacturing engineering — the corpus mirrors the real-world problem the assistant addresses (engineering knowledge locked in PDFs). The 2017 DOE final rule is the regulation behind the January 2023 product-line redesign the author led at Rheem Manufacturing.
